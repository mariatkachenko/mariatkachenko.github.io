...
describe('Maria Tkachenko portfolio', () => {
  ...
  it('switches between light and dark themes from the fixed bottom controls', () => {
    ...
    expect(lightThemeButton.querySelector('img')).toHaveAttribute('src', '/assets/maria/theme-sun-lossless.webp')
    expect(lightThemeButton.querySelector('img')).toHaveAttribute('alt', '')
    expect(darkThemeButton.querySelector('img')).toHaveAttribute('src', '/assets/maria/theme-moon-lossless.webp')
  ...
  it('opens Work Projects as a separate route with fixed navigation and a back action', () => {
    ...
    expect(cover.querySelector('.mts-project-card__artwork')).toHaveAttribute('src', '/assets/maria/mts-pay-card-composition.webp')
