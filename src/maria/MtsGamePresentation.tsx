...
export default function MtsGamePresentation({ language }: MtsGamePresentationProps) {
  ...
  return <section className="mts-presentation mts-presentation--dark" aria-label={copy.slide}>
