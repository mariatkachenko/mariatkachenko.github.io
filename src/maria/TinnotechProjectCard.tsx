...
export default function TinnotechProjectCard({ language, loadArtwork }: TinnotechProjectCardProps) {
  return <div className="tinnotech-project-card">
    ...
    <span className="tinnotech-project-card__artwork" aria-hidden="true">
      {loadArtwork && <>
        <img className="tinnotech-project-card__logo" src="/assets/maria/tinnotech-logo.png" alt="" draggable="false" />
        <img className="tinnotech-project-card__phones" src="/assets/maria/tinnotech-phones.png" alt="" draggable="false" />
        <img className="tinnotech-project-card__poll" src="/assets/maria/tinnotech-poll.png" alt="" draggable="false" />
        <img className="tinnotech-project-card__chat" src="/assets/maria/tinnotech-chat.png" alt="" draggable="false" />
      </>}
    </span>
