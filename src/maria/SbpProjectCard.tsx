...
export default function SbpProjectCard({ onOpen, ariaLabel, language, loadArtwork, disabled = false }: SbpProjectCardProps) {
  return <button className="wallet-project-card sbp-project-card" type="button" data-interaction-sound="open" disabled={disabled} onClick={onOpen} aria-label={ariaLabel}>
